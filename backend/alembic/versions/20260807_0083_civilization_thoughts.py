            ...
            [
              {
                ...
                "lenses": [
                  ...
                  {"name": {"zh": "最小必要規則", "en": "Minimum necessary rule"}, "text": {"zh": "只建立足以協作的規則，不把可選擇的事變成命令。", "en": "Create only enough rules for coordination; do not turn choices into commands."}}
                ],
